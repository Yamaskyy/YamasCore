...
public class LogUtil {
	...
	public static void update(String content){
		Bukkit.getLogger().info("[YamasCore][Updater] > " + content);
	}
	
	public static void parser(String content){
		Bukkit.getLogger().severe("[YamasCore][Parser] #> " + content);
	}
	
	public static void info(String content){
		Bukkit.getLogger().info("[YamasCore] " + content);
	}
	
	public static void warning(String content){
		Bukkit.getLogger().warning("[YamasCore] " + content);
	}
	...
	public static boolean exception(String cause, StackTraceElement[] ste){
		error("");
		error("[YamasCore] Severe error:");
	    error("");
	    error("Server Information:");
	    error("  YamasCore: " + Main.getVersion());
